...
Subsequent calls to :ref:`mongoc_client_pool_push` respect the new minimum size, and close the least recently used :ref:`mongoc_client_t` if the minimum size is exceeded.
