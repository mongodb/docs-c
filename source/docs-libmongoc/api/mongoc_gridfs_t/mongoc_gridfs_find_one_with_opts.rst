.. _mongoc_gridfs_find_one_with_opts
...
Returns a newly allocated :ref:`mongoc_gridfs_file_t` if successful. You must free the resulting file with :ref:`mongoc_gridfs_file_destroy()` when no longer in use.
