.. _mongoc_collection_read_command_with_opts
...
Execute a command on the server, applying logic that is specific to commands that read, and taking the MongoDB server version into account. To send a raw command to the server without any of this logic, use :ref:`mongoc_collection_command_simple`.
...
.. |generic-cmd| replace:: :ref:`mongoc_collection_command_with_opts`
