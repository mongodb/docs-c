.. _mongoc_collection_read_write_command_with_opts
...
Execute a command on the server, applying logic for commands that both read and write, and taking the MongoDB server version into account. To send a raw command to the server without any of this logic, use :ref:`mongoc_collection_command_simple`.
