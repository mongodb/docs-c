...
Create a ``mongoc_apm_callbacks_t`` with :ref:`mongoc_apm_callbacks_new`, set callbacks on it, then pass it to :ref:`mongoc_client_set_apm_callbacks` or :ref:`mongoc_client_pool_set_apm_callbacks`.
