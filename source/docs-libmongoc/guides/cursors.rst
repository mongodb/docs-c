...
Tailable cursors are cursors that remain open even after they've returned a final result. This way, if more documents are added to a collection (i.e., to the cursor's result set), then you can continue to call :ref:`mongoc_cursor_next()` to retrieve those additional results.
...
.. seealso::
  ...
  | :ref:`mongoc_cursor_set_max_await_time_ms`.
